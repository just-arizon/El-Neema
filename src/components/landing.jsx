    ...
    <motion.div className="relative flex flex-row gap-8">
      ...
      <div className="landing relative flex flex-col justify-center items-center z-10 w-full h-screen">
        <div className="flex flex-col justify-center mb-5 mt-5 lg:pr-40 lg:pl-20 px-8">
          ...
          >
            <motion.div variants={textVariant} custom={0} className="text-orange-400">Empowering Underprivileged</motion.div>
            <motion.div variants={textVariant} custom={1}>Children For A Brighter Tomorrow</motion.div>
          </motion.h1>
          <motion.p
            initial="hidden"
            animate="visible"
          ...
          >
            The Watch Word: Discover how much Light each child can bring into the world as individuals, inspiring hope and igniting change to make a difference today.
          </motion.p>

          <div className="flex lg:justify-start justify-center pt-5 gap-3">
            <Button
              as={Link}
              href={"#"}
